...
function addResource(resource, controller) {
  ...
  if(controller.destroyComment) addRoute('/' + resource + '/:id', 'delete', controller.destroyComment);
  if(controller.destroyComment) addRoute('/' + resource + '/:id/deleteComment', 'get', controller.destroyComment);
  // Deal with redirection
  if(controller.redirect) addRoute('/', 'GET', controller.redirect);
  if(controller.addComment) addRoute('/' + resource + '/addComment/:id', 'POST', controller.addComment);
  if(controller.processPostEdit) addRoute('/' + resource + '/edit', 'post', controller.processPostEdit);
}
